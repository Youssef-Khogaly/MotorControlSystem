# 1 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.c" 2
...
# 1 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.h" 1
# 11 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.h"
# 1 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 11 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../std_lib.h" 1
# 11 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../std_lib.h"
...
# 11 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../std_lib.h" 2
...
# 12 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../std_lib.h" 2
...
# 13 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../std_lib.h" 2
...
# 14 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../std_lib.h" 2
# 11 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../compiler.h" 1
# 10 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../compiler.h"
...
# 10 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../compiler.h" 2
# 12 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 27 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../mcal_std_types.h"
typedef uint8_t Std_ReturnType;
# 11 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.h" 2

# 1 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/../DeviceConfig/DeviceConfig.h" 1
# 12 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 28 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    low = 0,
    high
}logic_t;
...
# 114 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 8 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.c" 2
...
# 26 "../PIC18F4620/MotorControlSystem/MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType gpio_pin_direction_intialize( const pinConfig_t* pinCon){
    Std_ReturnType ret = ((Std_ReturnType)0x01);
    if(!(pinCon) || (pinCon->port > 4) || (pinCon->pinIndex > 7))
    {
    ...
    else
    {
        switch (pinCon->direction){
                case output:
                  (*tris_reg[pinCon->port] &= (~(((uint8_t)(1<<pinCon->pinIndex)))));
                 break;
                case input:
                  (*tris_reg[pinCon->port] |= ((uint8_t)(1<<pinCon->pinIndex)));
                break;
...
Std_ReturnType gpio_pin_get_direction(const pinConfig_t* pinCon ,direction_t* dir_status){
    ...
    if(!(pinCon) || !(dir_status)|| (pinCon->port > 4) || (pinCon->pinIndex > 7))
    {
        ret = ((Std_ReturnType)0x01);
    }
    else
    {
      *dir_status = ((*tris_reg[pinCon->port] >> pinCon->pinIndex) & (uint8_t)0x01);
    }
    return ret;
}
Std_ReturnType gpio_pin_write_logic(const pinConfig_t* pinCon ,logic_t logic){
    ...
    else
    {
        switch (logic){
          case low:
            (*lat_reg[pinCon->port] &= (~(((uint8_t)(1<<pinCon->pinIndex)))));
            break;
          case high:
            (*lat_reg[pinCon->port] |= ((uint8_t)(1<<pinCon->pinIndex)));
            break;
...
Std_ReturnType gpio_pin_read_logic(const pinConfig_t* pinCon ,logic_t* ret_logic){
    Std_ReturnType ret = ((Std_ReturnType)0x00);
    if(!(pinCon) || !(ret_logic) || (pinCon->port > 4) || ( pinCon->pinIndex > 7))
    {
        ret = ((Std_ReturnType)0x01);
    }
    else
    {
        *ret_logic = ((*port_reg[pinCon->port] >> pinCon->pinIndex) & (uint8_t)0x01);
    }
    return ret;
}
